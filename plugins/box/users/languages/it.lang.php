<?php
    ...
    return array(
        'users' => array(
            ...
            'Register new user' => '<Registra nuovo utente',
            'Delete user: :user' => 'Elimina utente: :user',
            'User <i>:user</i> have been deleted.' => 'Utente <i>:user</i> è stato eliminato.',
            'This user already exists' => 'Questo utente esiste già',
            'This email already exists' => 'Questa email esiste già',
            'Changes saved' => 'Le modifiche sono state salvate',
            'Wrong old password' => 'La vecchia password è errata',
            ...
            'New user have been registered.' => 'Il nuovo utente è stato registrato.',
            'Captcha' => 'Codice captcha',
            'Registration' => 'Registrazione',
            'Username' => 'Nome utente',
            'User email is invalid' => 'E-mail utente non valida',
            ...
            'Users - Password Recover' => 'Utenti - Recuper della Password',
            'New Password' => 'Nuova password',
            ...
            'User registration is closed.' => 'La registrazione utenti è chiusa.',
