<?php
    ...
    return array(
        'blocks' => array(
            ...
            'This block already exists' => 'Questo blocco esiste già',
            'This block does not exist' => 'Questo blocco non esiste',
            'Delete block: :block' => 'Elimina blocco: :block',
            'Block content' => 'Contenuto del blocco',
            'Block <i>:name</i> deleted' => 'Il blocco <i>:name</i> è stato eliminato',
